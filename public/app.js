...
const i18n = {
  zh: {
    ...
    modelPromptPlaceholder: "例如：最近3天高点回撤2%买入20%，之后每下跌2%再买20%，每笔上涨2%卖出",
    creator: "创建者",
    presetName: "预设名称",
    autoGenerated: "自动生成",
    generateSafeModel: "生成安全模型",
    saveAsPreset: "保存为预设",
    securityNote: "安全策略：不会执行任意 JavaScript，不使用 eval / Function。文字描述只会转换为已支持模型的参数化代码片段，并在浏览器本地回测。",
  ...
  en: {
    ...
    modelPromptPlaceholder: "Example: buy 20% after a 2% pullback from the recent 3-day high, add 20% after each 2% drop, sell each lot after a 2% gain",
    creator: "Creator",
    presetName: "Preset Name",
    autoGenerated: "Auto-generated",
    generateSafeModel: "Generate Safe Model",
    saveAsPreset: "Save as Preset",
    securityNote: "Safety: arbitrary JavaScript is never executed, and eval / Function are not used. Text is converted only into supported parameterized model presets and backtested in the browser.",
