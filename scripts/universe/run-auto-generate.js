    ...
    try {
      ...
      if (bestQualifying) {
        ...
        await saveOptimizationResult(pool, {
          ...
          trainBuyWin: engine.buildBuyWinStats(bestQualifying.best.last.trades),
          testYear1BuyWin: engine.buildBuyWinStats(scoredYear1.trades),
          testYear2BuyWin: engine.buildBuyWinStats(scoredYear2.trades),
