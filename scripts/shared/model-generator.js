  ...
  const cleanCondition = (condition) => {
    ...
    return {
      ...
      waveThreshold: condition.indicator === "drawdownFromWaveHigh" || condition.indicator === "riseFromWaveLow"
        ...
        : condition.indicator === "daysSinceNewWaveLow"
